...
The methods are based on our preprint [Joglekar et al. (2020)](https://www.biorxiv.org/content/10.1101/2020.08.27.268730v1) and the [scISOrSeq workflow](https://www.nature.com/articles/nbt.4259?draft=marketing)
...
Alternatively, you can  download a PDF of the vignette at the following link:

```{r, echo = FALSE}
xfun::embed_file('vignettes/scisorseqr_standardWorkflow.pdf', name = 'scisorseqr_vignette',
                 text = 'scisorseqr vignette')
```
